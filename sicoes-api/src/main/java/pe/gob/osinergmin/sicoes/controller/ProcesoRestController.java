...
public class ProcesoRestController extends BaseRestController{
	...
	public Page<Proceso> buscarProcesos(
		...
		return procesoService.listarProcesos(fechaDesde,fechaHasta,idEstado,idSector,idSubsector,nroProceso,nombreProceso,nroExpediente,pageable,getContexto());
	}
