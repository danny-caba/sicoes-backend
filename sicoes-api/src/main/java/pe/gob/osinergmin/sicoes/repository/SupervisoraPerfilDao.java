...
//	
	...
	@Query(value="select sp from SupervisoraPerfil sp, PropuestaProfesional pp "
			+ "left join sp.sector se "
			+ "left join sp.actividad a "
			+ "left join sp.subsector ss "
			+ "left join sp.subCategoria sc "
			...
			+ "left join pp.supervisora pps "
			+ "left join pp.propuesta ppp "
			+ "left join pp.perfil ppe "
			+ "left join ppp.procesoItem ppi "
			+ "left join ppi.proceso pro "
			+ "where s.idSupervisora = pps.idSupervisora "
			+ "and pe.idListadoDetalle = ppe.idListadoDetalle "
			+ "and ppp.idPropuesta = :idPropuesta ",
			countQuery = "select count(sp) from SupervisoraPerfil sp, PropuestaProfesional pp "
					+ "left join  sp.supervisora s "
					+ "left join  sp.sector se "
					+ "left join  sp.actividad a "
					+ "left join  sp.subsector ss "
					...
					+ "and pe.idListadoDetalle = ppe.idListadoDetalle "
					+ "and ppp.idPropuesta = :idPropuesta ")
	public Page<SupervisoraPerfil> buscarPorIdPropuesta(Long idPropuesta, Pageable pageable);
	...
	@Query(value="select sp from SupervisoraPerfil sp "
			...
			+ "where pe.idListadoDetalle = :idPerfil "
			+ "and e.codigo='"+Constantes.LISTADO.ESTADO_SUPERVISORA.VIGENTE+"'",
			countQuery = "select count(sp) from SupervisoraPerfil sp "
					+ "left join  sp.supervisora s "
					+ "left join  sp.sector se "
					...
					+ "where pe.idListadoDetalle = :idPerfil "
					+ "and e.codigo='"+Constantes.LISTADO.ESTADO_SUPERVISORA.VIGENTE+"'")
	public Page<SupervisoraPerfil> buscarPorIdPerfil(Long idPerfil, Pageable pageable);
}
