...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/**.html").permitAll().antMatchers("/**.jsp").permitAll()
				...
				.antMatchers(HttpMethod.GET, "/api/divisiones").permitAll()
				.antMatchers(HttpMethod.GET, "/api/listado/perfiles/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/divisiones/perfiles/{idUsuario}/**").permitAll()
				.antMatchers(HttpMethod.POST, "/api/requerimientos/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/requerimientos/**").permitAll()
				.antMatchers(HttpMethod.PATCH, "/api/requerimientos/{uid}/archivar/**").permitAll()
				.antMatchers(HttpMethod.PUT, "/api/requerimientos/{uid}/archivar/**").permitAll()
				.antMatchers(HttpMethod.POST, "/api/informes/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/requerimientos/{uid}/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/supervisoras/profesionales/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/saldos/{uid}/**").permitAll()
				.antMatchers(HttpMethod.POST, "/api/invitaciones/**").permitAll()
				.antMatchers(HttpMethod.DELETE, "/api/invitaciones/{uid}/eliminar/**").permitAll()
