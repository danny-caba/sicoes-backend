...
<%!
    ...
    */
     ...
     */
    private static final String CSS_NAME = "generico.css";
    /**
                ...
                for (int i = 0; i < entry.length; i++) {
                    ...
                    if (entry[i].isDirectory()) {
                        ...
                        if (entry[i].canRead()) {
                            ...
                            if (USE_POPUP) {
                                // String ahrefTail ="<a onmousedown=\"dis()\" href=\"" + request.getContextPath() +"/console/tailview.jsp" + "?";
                                // link = ahrefTail + "file=" + name + "\" target=\"_blank\">" + buf + "</a>";
